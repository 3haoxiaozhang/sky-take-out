...
//        );
    ...
    public void paySuccess(String outTradeNo) {
        ...
        Map map=new HashMap();
        map.put("type",1);//1表示来单提醒  2表示顾客催单
    ...
    public OrderVO orderDetail(Long id) {
       //先根据Id查询出订单中菜品信息，封装成一个菜品集合返回
        List<OrderDetail> list=orderDetailMapper.getByOrderId(id);

        //根据订单id查询出userid，返回该用户的地址
    ...
    public OrderStatisticsVO statistics() {
        //查询出所有的订单
        List<Orders> list=orderMapper.getAllOrder();
        //对订单进行遍历，对应的状态加一
    ...
    public void confirm(OrdersConfirmDTO ordersConfirmDTO) {
        ...
        orderMapper.updateConfirm(ordersConfirmDTO.getId(),ordersConfirmDTO.getStatus());
    }
